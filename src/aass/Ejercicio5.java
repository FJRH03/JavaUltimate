...
public class Ejercicio5 {
    ...
    public static void main(String[] args) {
        ...
        int contador = 0; // esta variable nos dira el numero de veces a sumar los numeros
        int i = 0;
        System.out.println("Ingrese numero de contador de veces a sumar: ");
        contador = teclado.nextInt(); // Aqui leemos el numero de veces a contar
        do {
            System.out.println("Ingresa un numero entero: "); // pedimos los numeros al usuario
